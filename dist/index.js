...
app.get('/debtors', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var connectingResult, debtors, disconnectingResult, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                connectingResult = _a.sent();
                console.log('connectingResult:', connectingResult);
                return [4 /*yield*/, db.getDebtors()];
            case 2:
                debtors = _a.sent();
...
app.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var connectingResult, addResult, disconnectingResult, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
